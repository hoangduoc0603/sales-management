...
| [0003](0003-storage-roles-partition-archive.md) | Accepted | Storage role, transaction/audit partition và archive. |
...
| [0008](0008-mandatory-audit-outbox.md) | Accepted | Audit outbox bền vững, projection audit bất đồng bộ. |
